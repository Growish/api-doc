define({ "api": [
  ...
  },
  {
    ...
    "title": "Get Business Coupon available with information of Owner Coupon already buyed",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "success": {
      "examples": [
        {
          "title": "Owner response example",
          "content": "{\"code\":200,\"data\":[{\"description\":\"Foo Description\",\"validFrom\":\"2018-01-01 00:00:00\",\"validTo\":\"2018-12-31 23:59:59\",\"imageUrl\":\"https:\\/\\/viaplacehold.it\\/300x150?text=coupon\",\"id\":\"5aa15bcbff9822173f8b456b\",\"buyed\":true}],\"message\":\"OK\",\"pagination\":null,\"uri\":\"https:\\/\\/apidev.growish.com\\/v1\\/business-coupon\\/\",\"method\":\"GET\"}",
          "type": "json"
        }
      ]
    },
    ...
    "examples": [
      {
        "title": "Angular Growish API Client:",
        "content": "gwApi.request('businessCoupon').read().then(function success(businessCoupon) { }, function error(err) { });",
        "type": "js"
      }
    ],
  ...
  {
    "type": "post",
    "url": "/buy-business-coupon/",
    "title": "Buy a Business Coupon",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "type": "String",
            "optional": false,
            "field": "businessCouponId",
            "description": "<p>The Business Coupon Id</p>"
          }
        ]
      }
    },
    "name": "buyBusinessCoupon",
    "group": "Business",
    "permission": [
      {
        "name": "Owner",
    ...
    "success": {
      "examples": [
        {
          "title": "Owner response example",
          "content": "{\"code\":200,\"data\":{\"description\":\"Foo Description\",\"validFrom\":\"2018-01-01 00:00:00\",\"validTo\":\"2018-12-31 23:59:59\",\"imageUrl\":\"https:\\/\\/viaplacehold.it\\/300x150?text=coupon\",\"id\":\"5aa15bcbff9822173f8b456b\"},\"message\":\"Operazione completata con successo\",\"pagination\":null,\"uri\":\"https:\\/\\/apidev.growish.com\\/v1\\/buy-business-coupon\\/\",\"method\":\"POST\"}",
          "type": "json"
        }
      ]
    },
    ...
    "examples": [
      {
        "title": "Angular Growish API Client:",
        "content": "gwApi.request('buyBusinessCoupon').save({ businessCouponId: \"5aa15bcbff9822173f8b456b\" }).then(function success(response) { }, function error(err) { });",
        "type": "js"
      }
    ],
    "filename": "./rpc-geo-business.js",
  ...
  },
  {
    "type": "get",
    "url": "/business-coupon/",
    "title": "Get all User buyed Business Coupon",
    "name": "userBusinessCoupon",
    "group": "Business",
    "permission": [
      {
        "name": "Owner",
    ...
    "examples": [
      {
        "title": "Angular Growish API Client:",
        "content": "gwApi.request('userBusinessCoupon').read().then(function success(businessCoupon) { }, function error(err) { });",
        "type": "js"
      }
    ],
    "filename": "./rpc-geo-business.js",
